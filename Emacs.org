...
#+begin_src emacs-lisp
  ...
  (defconst cfg/fill-dark-columnn 60)
...
default completion commands. [[https://github.com/Yevgnen/ivy-rich][ivy-rich]] adds extra columns to a few of
...
#+begin_src emacs-lisp
  ...
  (defun cfg/org-font-setup ()
    ...
    (dolist (face '((org-level-1 . 1.2)
      ...
      (set-face-attribute
        (car face) nil
          :font "Sans" :weight 'regular :height (cdr face)))
...
set up =org-babel-load-languages= for each language you'd like to use.
...
[[https://github.com/jming422/fira-code-mode][Fira-code-mode]] is a simple minor mode for Fira Code ligatures.

#+begin_src emacs-lisp

  (when (window-system)
    (use-package fira-code-mode)
    ;; disable unwanted ligatures for fira-code mode
