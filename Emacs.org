...
#+begin_src emacs-lisp
  ...
  (defconst cfg/default-font-size 150)
  (defconst cfg/fill-column 85)
  (defconst cfg/fill-dark-column 100)
  (defconst cfg/ws-color "#767679")
...
#+begin_src emacs-lisp
  (use-package minions)
  (setq minions-prominent-modes '(wc-mode display-battery-mode))
  (minions-mode 1)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (custom-set-faces
   '(whitespace-space
     ((t '(:foreground cfg/ws-color :background nil))))
   '(whitespace-tab
     ((t '(:foreground cfg/ws-color :background nil)))))
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    (define-key lsp-mode-map (kbd "C-c C-h")
  ...
  (defun markdown-raw-links (&rest ignore)
      ...
      (save-excursion
        (goto-char (point-min))
        (while
            (re-search-forward markdown-regex-link-inline nil t)
          (replace-match
...
“Windmove” keys. Windmove is a library built into GnuEmacs starting with version 21. It lets you move point from window to window using Shift and the arrow keys.
